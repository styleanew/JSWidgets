/*
 * panzoom Directive ("../scripts/directives/panzoom.js")
 */
            ...
            return {
                ...
                controller: ['$scope', '$element',
                    function ($scope, $element) {
                        ...
                        $scope.config.initialPanX = $scope.config.initialPanX !== undefined ? $scope.config.initialPanX  : -160;
                        $scope.config.initialPanY = $scope.config.initialPanY || -140;
                        ...
                        if ($scope.config.keepInBounds && $scope.config.neutralZoomLevel !== 0) {
                            console.warn('You have set keepInBounds to true and neutralZoomLevel to ' + $scope.config.neutralZoomLevel +
                                         '. Be aware that the zoom level cannot get below ' + $scope.config.neutralZoomLevel);
                        }
...
/*
 * PanZoom Service ("../scripts/services/PanZoomService.js")
 */
...
/*
 * panzoomwidget Directive ("../scripts/directives/panzoomwidget.js")
 */
...
function ($document, PanZoomService) {
  ...
  return {
    ...
    '<div ng-click="zoomIn()" ng-mouseenter="zoomToLevelIfDragging(config.zoomLevels - 1)" class="zoom-button zoom-button-in plus"></div>' +
    ...
    '</div>' +
    '<div ng-click="zoomOut()" ng-mouseenter="zoomToLevelIfDragging(0)" class="zoom-button zoom-button-out minus"></div>' +
...
/*
 * zoomController Directive ("../scripts/controllers/zoomController.js")
 */

angular.module('closelook', ['panzoom', 'panzoomwidget'])

.controller('zoomController', ['$scope', 'PanZoomService',
